function ToggleFullScreen() {
		...
		var buildUrl = "Build";
		var loaderUrl = buildUrl + "/Fruits_Cut_3D.loader.js";
		var config = {
        dataUrl: buildUrl + "/Fruits_Cut_3D.data",
        frameworkUrl: buildUrl + "/Fruits_Cut_3D.framework.js",
        codeUrl: buildUrl + "/Fruits_Cut_3D.wasm",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "Gamebol",
        productName: "Fruits Cut 3D",
        productVersion: "1",
      };
